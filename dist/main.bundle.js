...
var CompleteComponent = (function () {
    ...
    CompleteComponent.prototype.ngOnInit = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Observable"].interval(30000).subscribe(function (x) {
            _this.getOrders();
        });
        this.getOrders();
        this.Math = Math;
